    ...
    init() {
      ...
      const $formDom = $(`
        ...
        <form class="form-container">
          <div class="form-line">
            <lable for="formNameInput" class="form-lable">name:</lable>
            <input id="formNameInput" type="text" class="form-input" placeholder="Please input your name.">
          </div>
          <div class="form-line">
            <lable for="formAgeInput" class="form-lable">age:</lable>
            <input id="formAgeInput" type="number" min="5" max="130" class="form-input" placeholder="Please input your age.">
          </div> 
          <div class="form-line">
            <lable class="form-lable">Sex:</lable>
            <input id="formSexMale" type="radio" name="sex" value="male">
            <lable for="formSexMale" >male</lable>
            <input id="formSexFemale" type="radio" name="sex" value="female">
            <lable for="formSexFemale">female</lable>
          </div> 
